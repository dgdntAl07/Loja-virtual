                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="categoria" class="form-select" name="categoria"
                                                                ...
                                                                <?php if (isset($categoriasExistentes)): ?>
                                                                    <?php foreach ($categoriasExistentes as $categoria): ?>
                                                            ...
                                                            <input type="text" class="form-control" name="newCategoria"
                                                                id="inputCategoria" placeholder="Nova categoria..."
                                                                style="display: none;">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 mb-3">
                                ...
                                <?php if (isset($produtos_list)): ?>
                                    <?php foreach ($produtos_list as $produto): ?>
                                        <tr>
                                            ...
                                            <?php if (!empty($produto->id_ctg)): ?>
                                                <td><?= $produto->nome_categoria; ?></td>
                                            <?php else: ?>
                                                <td class="text-danger">aagbbadba</td>
                                            <?php endif; ?>

                                            <td class="table-action align-items-center">

                                                <button class="btn btn-link p-1 link-dark" data-bs-toggle="modal"
                                                    data-bs-target="#editproduto<?= $produto->id; ?>">
                                                ...
                                                <button class="btn btn-link p-1 link-dark" data-bs-toggle="modal"
                                                    data-bs-target="#enviarLixeira<?= $produto->id; ?>">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
